  ...
  return (
    <section className="bg-white py-[56px] md:py-[120px]">
      <div className="container-inner">
        ...
        <div className="mt-10 md:mt-16 m-carousel m-carousel-3">
          {tiers.map((t, i) => (
            <div
              key={t.code}
            ...
            >
              ...
              <h3 className="mt-3 text-[20px] md:text-[22px] font-semibold tracking-tight text-ink">
                {t.name}
              </h3>
              ...
              <div
                className="mt-5 md:mt-6 inline-block font-mono text-[10.5px] tracking-[0.14em] uppercase px-2.5 py-1 rounded border"
                style={{
              ...
              <ul className="mt-6 md:mt-7 space-y-2.5">
                {t.items.map((it) => (
                  <li
                    key={it}
                    className="text-[13.5px] md:text-[14px] leading-[1.5] text-ink flex gap-3"
                  >
